...
export function PreviewEmptyState({ onSuggestionClick }: PreviewEmptyStateProps) {
    const suggestions = [
        "Build a resume for a Senior React Developer",
        "Create a creative marketing manager resume",
        "Make a professional ATS-friendly accountant resume",
        "Draft a resume for a recent computer science grad"
    ];

    return (
        <div className="absolute inset-0 flex flex-col items-center justify-center bg-gray-50/50 dark:bg-gray-900/50 overflow-hidden">
            {/* Background Decorations */}
            <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-blue-100 dark:bg-blue-900/20 rounded-full mix-blend-multiply dark:mix-blend-lighten filter blur-3xl opacity-30 animate-pulse"></div>
            <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-purple-100 dark:bg-purple-900/20 rounded-full mix-blend-multiply dark:mix-blend-lighten filter blur-3xl opacity-30 animate-pulse" style={{ animationDelay: '2s' }}></div>
            ...
            <div className="relative z-10 flex flex-col items-center text-center max-w-lg px-8">
                ...
                <div className="w-full max-w-sm space-y-4 mb-10 opacity-40 select-none pointer-events-none">
