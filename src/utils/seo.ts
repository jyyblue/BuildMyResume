...
export const SEO_CONSTANTS = {
  ...
  DEFAULT_KEYWORDS: 'resume builder, resume builder in buildmyresume.live, CV builder, ATS friendly resume, professional resume, open source resume builder, privacy resume builder, AI resume builder, job application, career tools',
} as const; 